...
ctr run -t -d --net-host --log-uri file://${INFRA_NGINX_LOG_FILE} --mount type=bind,src=${COMMON_MIRROR_DIR},dst=/usr/share/nginx/html,options=rbind:r ${CABIN_NGINX_VERSION} ${INFR_CONTAINERD_NAME}
